            ...
            if (data != 0) {
                ...
                for (i = 0; i < data.length; i++) {
                    $("#tabela_galeria_post tbody").append(
                            ...
                            "<td align=\"center\">" +
                            "<button type=\"button\" class=\"btn btn-secondary btn-sm\" onclick=\"edita_blog_postagem_galeria(" + data[i].id_blog_postagem_galeria + ")\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar imagem " + data[i].descricao + "\"><i class=\"far fa-edit fa-fw\" aria-hidden=\"true\"></i></button>&nbsp;" +
