            ...
            if (data != 0) {
                ...
                for (i = 0; i < data.length; i++) {
                    $("#tabela_subcategorias tbody").append(
                            ...
                            "<td align=\"center\">" +
                            "<button type=\"button\" class=\"btn btn-secondary btn-sm\" onclick=\"edita_blog_subcategorias(" + data[i].id_blog_subcategorias + ")\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar subcategoria " + data[i].descricao + "\"><i class=\"far fa-edit fa-fw\" aria-hidden=\"true\"></i></button>&nbsp;" +
                            "</td>" +
                            "</tr>"
                            );
