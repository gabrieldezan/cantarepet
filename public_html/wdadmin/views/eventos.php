            ...
            <div class="card">
                <div class="card-body">
                    <div id="div_tabela" class="table-responsive">
                        <table id="tabela_eventos" class="table table-sm table-hover table-striped table-bordered" cellspacing="0" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Descrição</th>
                        ...
                        <div class="col-sm">
                            <div class="alert alert-warning" role="alert">
                                <center>
                                    ...
                                    <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/eventos/cadastro">
...
<script src="<?php echo URL ?>wdadmin/scripts/eventos.js"></script>