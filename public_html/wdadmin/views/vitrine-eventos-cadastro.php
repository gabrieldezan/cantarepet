<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Eventos da Vitrine</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>vitrine-eventos">Eventos da Vitrine</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#times" role="tab">
                                <span class="hidden-sm-up"><i class="fas fa-palette"></i></span>
                                <span class="hidden-xs-down"><i class="fas fa-palette"></i>&nbsp;Times</span>
                            </a>
                        </li>
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>vitrine-eventos/cadastro">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_vitrine_eventos_cadastro" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="inputIdVitrineEventosCadastro" name="inputIdVitrineEventosCadastro" value="<?php echo $id ?>" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" required id="inputValor" name="inputValor" placeholder="ex.: 70,00" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Valor (ingresso com combat shirt)*</label>
                                    <div class="col-sm-8">
                                        <input type="text"  class="form-control form-control-sm" required id="inputValorCombatShirt" name="inputValorCombatShirt" placeholder="ex.: 100,00" />
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="tab-pane p-20" id="times" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-6">
                                    <table id="tabela_evento_times" class="table table-sm table-hover table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Time</th>
                                                <th>Ações</th>
                                ...
                                <div class="col-sm-6">
                                    <form id="form_vitrine_evento_times" method="post" enctype="multipart/form-data">
                                        <input type="hidden" id="inputIdVitrineEventoTimes" name="inputIdVitrineEventoTimes" value="" />
                                        <input type="hidden" id="inputIdVitrineEvento" name="inputIdVitrineEvento" value="<?php echo $id ?>" />
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label col-form-label-sm text-right">Nome do Time *</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" id="inputTime" name="inputTime" placeholder="ex.: Time 1" required />
                                            </div>
                                        </div>
                                        <div class="form-group row text-right">
                                            <div class="col-sm-12">
                                                <button id="botao_salvar_time_evento" type="submit" class="btn btn-success btn-sm"><i class="fas fa-save" aria-hidden="true"></i>&nbsp;Salvar</button>
                                                <button id="botao_nova_time_evento" type="button" class="btn btn-info btn-sm"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;Novo Time</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script src="<?php echo URL ?>scripts/vitrine-eventos-cadastro.js"></script>