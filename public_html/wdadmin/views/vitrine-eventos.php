<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Eventos da Vitrine</li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    <div id="div_tabela" class="table-responsive">
                        <table id="tabela_vitrine_eventos" class="table table-sm table-hover table-striped table-bordered" cellspacing="0" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Descrição</th>
                        ...
                        <div class="col-sm">
                            <div class="alert alert-warning" role="alert">
                                <center>
                                    ...
                                    <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/vitrine-eventos/cadastro">
...
<script src="<?php echo URL ?>wdadmin/scripts/vitrine-eventos.js"></script>